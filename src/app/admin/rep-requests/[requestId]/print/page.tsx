      ...
      <RepStockRequestPrintView
        request={{
          ...
          items: request.items.map((item) => ({
            id: item.id,
            productLabel: `${item.product.nameAr ?? item.product.name}${item.variant ? ` — ${item.variant.phoneModel.phoneBrand.nameAr ?? item.variant.phoneModel.phoneBrand.name} / ${item.variant.phoneModel.nameAr ?? item.variant.phoneModel.name}` : ""}`,
