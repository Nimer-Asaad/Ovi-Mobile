    ...
    <div className="flex flex-col gap-6">
      ...
      <RepTransferInvoiceView
        movement={{
          ...
          variantLabel: movement.variant ? `${movement.variant.phoneModel.phoneBrand.nameAr ?? movement.variant.phoneModel.phoneBrand.name} / ${movement.variant.phoneModel.nameAr ?? movement.variant.phoneModel.name}${movement.variant.color ? ` / ${movement.variant.color.nameAr ?? movement.variant.color.name}` : ""}` : null,
