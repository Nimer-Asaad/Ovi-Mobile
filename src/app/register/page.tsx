...
import { registerCustomer, type RegisterCustomerState } from "./actions";
    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-10">
      <Card className="w-full max-w-sm">
        <CardHeader className="flex-col items-start justify-center gap-1">
          <CardTitle>إنشاء حساب عميل</CardTitle>
          <p className="text-sm text-neutral-bg/60">سجّل للتسوق بالتجزئة</p>
        </CardHeader>
